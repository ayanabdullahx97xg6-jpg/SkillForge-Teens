      ...
      <main className="pt-20">
        ...
        {currentPage === 'about' && (
          <div className="max-w-4xl mx-auto px-6 py-20">
            <h1 className="text-4xl font-extrabold text-white mb-6">About SkillForge Teens</h1>
            <p className="text-slate-400 text-lg leading-relaxed mb-6">
              SkillForge Teens is built for young creators, coders, and thinkers who want to build real things without boring lectures or rigid rules.
            </p>
          </div>
        )}
        ...
        {currentPage === 'courses' && (
          <div className="max-w-6xl mx-auto px-6 py-20">
            ...
            <p className="text-slate-400 mb-10">Select your path and start your journey today.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {["Python for Beginners", "AI Prompt Engineering", "Game Design 101"].map((course, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-[#121824] border border-slate-800">
                  <h3 className="text-xl font-bold text-white mb-2">{course}</h3>
                  <p className="text-slate-400 text-sm mb-4">Interactive modules built for teens.</p>
                  <button className="px-4 py-2 bg-[#00f2fe] text-black font-semibold rounded-lg text-sm">Start Learning</button>
                </div>
              ))}
            </div>
          </div>
